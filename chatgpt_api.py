...
def create_superquiz_questions(url):
    chatGPT_set_key()
    web_text = web_page.get_web_article(url)
    answer = chatGPT_request("create 5 multiple-choice questions with 1 correct answer and 3 incorrect answers each, based on this text: "+web_text)
    return answer
